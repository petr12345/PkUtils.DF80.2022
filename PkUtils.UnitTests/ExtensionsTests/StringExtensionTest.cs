...
namespace PK.PkUtils.UnitTests.ExtensionsTests
{
    ...
    public class StringExtensionTest
    {
        ...
        {
            string src = null!;
            Assert.ThrowsExactly<ArgumentNullException>(() => src.Left(2));
        }
        ...
        {
            string src = "abc";
            Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => src.Left(-2));
        }
        ...
        public void StringExtension_Left_03()
        {
            ...
            Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => src.Left(100));
        }
        ...
        {
            string src = null!;
            Assert.ThrowsExactly<ArgumentNullException>(() => src.LeftMax(2));
        }
        ...
        {
            string src = "abc";
            Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => src.LeftMax(-2));
        }
        ...
        {
            string src = null!;
            Assert.ThrowsExactly<ArgumentNullException>(() => src.Right(2));
        }
        ...
        {
            string src = "abc";
            Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => src.Right(-2));
        }
        ...
        {
            const string src = "abcd";
            Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => src.Right(100));
        }
        ...
        {
            string src = null!;
            Assert.ThrowsExactly<ArgumentNullException>(() => src.RightMax(2));
        }
        ...
        {
            string src = "abc";
            Assert.ThrowsExactly<ArgumentOutOfRangeException>(() => src.RightMax(-2));
        }
