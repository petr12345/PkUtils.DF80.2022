...
public class FileSearchTest
{
    ...
    private void Dump(string format, object arg0)
    {
        Dump(string.Format(format, arg0));
    }

    private void Dump(string format, object arg0, object arg1)
    {
        Dump(string.Format(format, arg0, arg1));
    }

    private void Dump(string format, object arg0, object arg1, object arg2)
    {
        Dump(string.Format(format, arg0, arg1, arg2));
    }

    private void Dump<T>(IEnumerable<T> seq, Func<T, string> fn)
    {
    ...
    private void Dump<T>(IEnumerable<T> seq)
    {
    ...
    private bool SearchDumpResultComparison(
    ...
    private bool PerformFilesSearch(
        string strPathA,
        ...
        SearchOption searchOption)
    {
        ...
        DirectoryInfo diRootA = new DirectoryInfo(strPathA);
        DirectoryInfo diRootB = new DirectoryInfo(strPathB);
    ...
    /// <param name="searchOption"> The search option. </param>
    /// <returns> true if it succeeds, false if it fails. </returns>
    private bool PerformFoldersSearch(
        string strPath,
        SearchOption searchOption)
    {
        string strMethodA = "'Non-recursively'";
        ...
        DirectoryInfo diRoot = new DirectoryInfo(strPath);
    ...
    private bool PerformFilesSearchEx(
    ...
    private bool PerformFoldersSearchEx(
      Action<string> dumpFn,
      string strPath,
      SearchOption searchOption)
    {
    ...
    public void FileSearch_SearchFilesTest_01()
    {
        ...
        bool actual = PerformFilesSearchEx(DumpFn, strPathA, searchPatternA, strPathB, searchPatternB,
    ...
    public void FileSearch_SearchDirectoriesTest_01()
    {
        ...
        bool actual = PerformFoldersSearchEx(DumpFn, strPath, SearchOption.AllDirectories);
    ...
    public void FileSearch_SearchDirectoriesTest_02()
    {
        static void DumpFn(string str) { Debug.WriteLine(str); }
        string strPath = Environment.GetFolderPath(Environment.SpecialFolder.System);
        bool actual = PerformFoldersSearchEx(DumpFn, strPath, SearchOption.TopDirectoryOnly);
