...
public class MethodsUtilsTest
{
    ...
    private static IEnumerable<string> AllNonStaticMethodNames
    {
        get
        {
            if (null == _allNonStaticMethodNames)
            {
    ...
    public void MethodsUtils_CallBaseBaseTest()
    {
        ...
        // i/ Calling a virtual method implemented in Z, through an instance of Z, in a variable of type Z
        // Note that the Z implementation is called.
        actual = (string?)z.RunInstanceMethod("DumpDecimals", args);
        Assert.That(actual, Is.EqualTo(expectedZ));

        // ii/ Calling a virtual method implemented in Z, through an instance of Z, in a variable of type X
        // Note that regardless of the declaration of x, the Z implementation is always called.
        ...
        Assert.That(actual, Is.EqualTo(expectedX));
    }
    ...
    public void MethodsUtils_GetStaticMethodTest()
    {
        ...
        Assert.That(actualMethod.Name, Is.EqualTo(strMethodName));
    }
