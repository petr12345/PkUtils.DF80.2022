...
/// <summary>   This is a test class for <see cref="TaskExtension"/> </summary>
[TestFixture()]
public class TaskExtensionTest
{
    ...
    public void ExecuteSynchronously_Test_02()
    {
        ...
        Assert.Throws<InvalidOperationException>(() =>
        {
            try
            {
                ...
                int result = TaskExtension.ExecuteSynchronously(testedTask);
            }
    ...
    /// <summary>  A test for TypeExtension.ExecuteSynchronously. </summary>
    [Test()]
    public void ExecuteSynchronously_Test_03()
    {
        ...
        int result = TypeExtension.ExecuteSynchronously(primeTask);
