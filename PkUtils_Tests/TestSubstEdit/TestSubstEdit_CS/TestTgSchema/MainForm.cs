    ...
    public partial class MainForm : Form
    {
        ...
        */
        ...
        public MainForm()
        {
            ...
            this._tgSchemaComponentslUserCtrl.SchemaTextBxCtrl.LostFocus += new EventHandler(_SchemaTextBxComponentsCtrl_LostFocus);
            this._tgSchemaComponentslUserCtrl.SchemaTextBxCtrl.TextChanged += new EventHandler(SchemaTextBxCtrl_TextChanged);
            this._tgSchemaComponentslUserCtrl.SchemaTextBxCtrl.evSubstEditContentsChanged += new ModifiedEventHandler(SchemaTextBxCtrl_SubstContentsChanged);
            this._tgSchemaComponentslUserCtrl.SchemaTextBxCtrl.evSelChaged += new EventHandler<SelChagedEventArgs>(OnSelChaged);

            this._tgSchemaLinesUserCtrl.AssignSubstMap(TaggingFieldTables._myLinesFieldsDescr);
            this._tgSchemaLinesUserCtrl.SchemaTextBxCtrl.LostFocus += new EventHandler(_SchemaTextBxLinesCtrl_LostFocus);
        ...
        protected static string GetPreviewText(SubstLogData<FieldTypeId> logData)
        {
            ...
            {
                strTmp = strTmp.Substring(0, nDex);
            }
        ...
        private void _SchemaTextBxComponentsCtrl_LostFocus(object sender, EventArgs e)
        {   // save od focus
        ...
        private void _SchemaTextBxLinesCtrl_LostFocus(object sender, EventArgs e)
        {   // save od focus
            Control ctrlOldFoc = sender as Control;
            // assigns SubstEditTextBoxCtrl or null if it was something else than SubstEditTextBoxCtrl
            _oldFocObj = null;
        ...
        private void SchemaTextBxCtrl_SubstContentsChanged(IModified sender, EventArgs e)
        {
        ...
        private void SchemaTextBxCtrl_TextChanged(object sender, EventArgs e)
        {
            this.UpdateToolstripButtons();
        }
        ...
        private void _btnProjTitle_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_PRJ_Title)));
        }

        private void _btnDocAuthor_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_DOC_Author)));
        }

        private void _btnDocTitle_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_DOC_Title)));
        }

        private void _btnDocCopyright_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_DOC_Copyright)));
        }

        private void _btnYear_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_Year)));
        }

        private void _btnMonth_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_Month)));
        }

        private void _btnDayOfWeek_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(new FieldTypeId(typeof(Field_DayOfWeek)));
        }

        private void _btnDog_Click(object sender, EventArgs e)
        {
        ...
        private void _btnProjName_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(EFieldLineType.IdField_ProjName);
        }
        private void _btnResistance_Click(object sender, EventArgs e)
        {
            InsertFieldInActiveBx(EFieldLineType.IdField_Resistance);
        }

        private void _btnDiameter_Click(object sender, EventArgs e)
        {
        ...
        private void OnBtnOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                eFileFmt fmt = (eFileFmt)nFilterIndex;
