...
// Suppress IDE0060 (Remove unused parameter) for the entry point parameter 'args'.
// We keep the parameter to preserve the standard Main signature even though it's unused.
...
public class Program : Singleton<Program>, IDisposableEx
{
    ...
    protected static void DoCloningTests()
    {
