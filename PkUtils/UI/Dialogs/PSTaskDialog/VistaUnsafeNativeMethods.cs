...
internal static partial class VistaUnsafeNativeMethods
{
    ...
    internal enum TASKDIALOG_FLAGS
    {
        ...
        /// <summary>
        /// Use command links rather than _buttons.
        /// </summary>
        TDF_USE_COMMAND_LINKS = 0x0010,

        /// <summary>
        /// Use command links with no icons rather than _buttons.
        /// </summary>
    ...
    internal enum TASKDIALOG_MESSAGES : uint
    {
        ...
        /// <summary>
        /// Check or uncheck the verification checkbox.
        /// </summary>
        TDM_CLICK_VERIFICATION = WM_USER + 113, // wParam = 0 (unchecked), 1 (checked), lParam = 1 (set key focus)

        /// <summary>
        /// Update the text of an element (no effect if originally set as null).
        /// </summary>
    ...
    ///// <param name="dwCommonButtons">Common push _buttons to show.</param>
    ...
    internal static extern void TaskDialogIndirect(
        ...
        [MarshalAs(UnmanagedType.Bool), Out] out bool pfVerificationFlagChecked); // PetrK 04/24/2012: adding MarshalAs attribute
    ...
    internal struct TASKDIALOGCONFIG
    {
        ...
        /// <summary>
        /// Bit flags for commonly used _buttons.
        /// </summary>
        ...
        /// <summary>
        /// Text for verification check box. often "Don't ask me again".
        /// </summary>
        [MarshalAs(UnmanagedType.LPWStr)]
